...
export const Income = () => {
  ...
  return (
    <div>
      <div>
        work: <input value={work} type={"number"} onChange={(e) => dispatch(changeValue({ work: +e.target.value }))} />
      </div>
      <div>
        donate:{" "}
        <input value={donate} type={"number"} onChange={(e) => dispatch(changeValue({ donate: +e.target.value }))} />
      </div>
